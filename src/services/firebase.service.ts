import { isSupported, onRegistered, register } from "firebase/messaging";
...
// lifetime of the app rather than only inside registerForPushNotifications.
onRegistered(messaging, (installationId) => {
  console.log("[FirebaseService] Registered installation ID:", installationId);
